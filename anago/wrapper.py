...
class Sequence(object):
    ...
    config_file = 'config_b10_e20.json'
    weight_file = 'model_weights_b10_e20.h5'
    preprocessor_file = 'preprocessor_b10_e20.pkl'

    def __init__(self, char_emb_size=25, word_emb_size=100, char_lstm_units=25,
                 word_lstm_units=100, dropout=0.5, char_feature=True, crf=False,
                 batch_size=10, optimizer='adam', learning_rate=0.001, lr_decay=0.9,
    ...
    def train(self, x_train, y_train, x_valid=None, y_valid=None, vocab_init=None):
        ...
        trainer = Trainer(self.model,
                          ...
                          preprocessor=self.p, save_path='./models')
